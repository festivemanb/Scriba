...
class TranscriptionsControllerTest < ActionController::TestCase
  ...
  test "should create transcription" do
    assert_difference('Transcription.count') do
      post :create, transcription: { description: @transcription.description, picture: @transcription.picture, title: @transcription.title, transcription: @transcription.transcription, user_nameLstring: @transcription.user_nameLstring }
    end
  ...
  test "should update transcription" do
    patch :update, id: @transcription, transcription: { description: @transcription.description, picture: @transcription.picture, title: @transcription.title, transcription: @transcription.transcription, user_nameLstring: @transcription.user_nameLstring }
    assert_redirected_to transcription_path(assigns(:transcription))
  end
